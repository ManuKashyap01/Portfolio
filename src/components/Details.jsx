...
export const ExpComp = () => {
  return (
    <div className='flex flex-wrap sm:justify-start justify-center gap-4'>
        {Experience.map((item)=>{
            return <div key={item.year} className="flex gap-2 p-4 sm:max-w-[200px] max-w-[275px] w-full flex-col shadow-soft">
                <p>{item.year}</p>
...
export const SkillComp = () => {
  return (
    <div className='flex flex-wrap sm:justify-start justify-center gap-4'>
        {Skills.map((item)=>{
            return <div key={item.title} className="flex gap-2 rounded-md p-4 sm:max-w-[90px] max-w-[120px] w-full flex-col items-center shadow-soft text-center">
